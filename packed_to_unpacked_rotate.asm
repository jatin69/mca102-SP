...
; Objective - Convert 16 BCD digits from packed to unpacked format using ROTATE instruction
...
code SEGMENT
    ...
    PROCESS:
        ...
        ; LEFT ROTATE AX by 4. AX= 0000-0000 0010-0001   becomes  0000-0010 0001-0000
        ROL AX,4
        ; RIGHT ROTATE AL BY 4. AX= 0000-0010 0001-0000   becomes  0000-0010 0000-0001
        ROR AL,4 
